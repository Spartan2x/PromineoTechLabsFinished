...
const alphabetStringToArray = alphabetString.split('');
console.log(alphabetStringToArray);
...
const alphabetArrayReverse = alphabetArray.reverse();
const alphabetArrayReverseToString = alphabetArrayReverse.join('');
console.log(alphabetArrayReverseToString);
...
let myTodoList = [];
myTodoList.push('eat', 'workout', 'study')
console.log(myTodoList)
myTodoList.splice(1,1) //The first number is the index you start at, the 2nd # is how many items to remove starting from there. 
console.log(myTodoList)
let yourToDoList = ['Cook', 'Read']
console.log(yourToDoList)
let ourToDoList = myTodoList.concat(yourToDoList) //here we used .concat to combine arrays
