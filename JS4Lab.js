...
//Answer:
// When you do not want the variable to change.
/*---------------------------------- Template Literals -------------------------------------*/
console.log(`-------------------------- 
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`${name} and ${friendName} are having ${food} and ${drink} for lunch.`)
...
//Answer:
console.log('harneet' + ' ' + 'and' + ' ' + 'sid' + ' ' + 'are having' + ' ' + 'pizza' + ' ' + 'and' + ' ' + 'water' + ' ' + 'for lunch.')
console.log(`-------------------------- 
Question 2a: Oh no`)
...
//Answer: It means the drink variable is already declared and has already been assigned a value.
 ...
 * ↓ YOUR CODE HERE ↓ */
const lunckTime = (foodChoice, drinkChoice) => {
   return `${name} and ${friendName} are having ${foodChoice} and ${drinkChoice} for lunch.`
}
console.log(lunckTime('Pizza','Water'))
...
console.log(foodForTodayAndTomorrow('sushi', 'soda', lunchTime('Pizza','Water')))
